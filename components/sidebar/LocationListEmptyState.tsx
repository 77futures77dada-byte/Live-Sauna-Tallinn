...
export function LocationListEmptyState({ locale }: { locale: Locale }) {
  ...
  return (
    <div className="flex animate-[card-enter_200ms_ease-out] flex-col items-center gap-2 rounded-xl border border-dashed border-warm-border px-4 py-10 text-center">
