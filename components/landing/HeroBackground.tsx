...
// cool frost glow over the light Ivory base, meeting in the middle. This is
...
// (see lib/hero.ts) and this component switches over automatically. Base is
// Ivory, not the old Fjord Ink navy, so it matches the light theme used
// everywhere else in the app (see HeroLanding).
  ...
  if (imageUrl) {
    return (
      <div className="absolute inset-0" aria-hidden>
        ...
        <div className="absolute inset-0 bg-[#F7F3EC]/60" />
      </div>
    );
  }
