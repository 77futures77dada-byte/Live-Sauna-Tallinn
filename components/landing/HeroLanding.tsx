...
export function HeroLanding({
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-y-auto overflow-x-hidden bg-[#0E2233] px-6 py-12 text-center text-[#EAF3F5]">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div
          className="mt-3 flex items-center gap-1.5 text-xs font-medium text-[#7C93A0]"
        ...
        >
          {liveSnapshot.activeLocations > 0 ? (
            ...
            <>
              <Users className="h-3.5 w-3.5 text-[#3FA9D6]" aria-hidden />
              <span>{dict.hero.liveSnapshotEmpty}</span>
            </>
          )}
        </div>
